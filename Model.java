...
public class Model 
{
    ...
    public int BALL_SIZE      = 20;     // Ball side
    ...
    public int HIT_BRICK      = 30;     // Score for hitting a brick
    public int HIT_BOTTOM     = -10;   // Score (penalty) for hitting the bottom of the screen
    ...
    {       
        ...
        // **************************************************************
        int WALL_TOP = 200;                     // how far down the screen the wall starts
